...
namespace AODevBlog.Web
{
    public class Startup
    {
        ...
        {
            services.Configure<CloudinaryOptions>(Configuration.GetSection("CloudinaryOpetions"));
